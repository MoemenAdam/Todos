  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    @media only screen and (max-width: 600px) {
      ...
      .hero { padding: 24px 20px 0 !important; }
...
<body>
  <div class="wrapper">
    ...
    <!-- Logo / Header -->
    <div class="header">
      <a href="#" class="logo-wrap" style="display:inline-flex;align-items:center;gap:10px;background:#ffffff;padding:10px 20px 10px 12px;border-radius:50px;text-decoration:none;">
        <!-- Logo Icon (inline SVG — renders everywhere) -->
        <span class="logo-icon" style="width:40px;height:40px;background:linear-gradient(135deg,#6c63ff,#a78bfa);border-radius:10px;display:inline-flex;align-items:center;justify-content:center;">
        ...
        <span class="logo-name" style="font-family:'Syne',Arial,sans-serif;font-weight:800;font-size:22px;color:#1a1a2e;letter-spacing:-0.5px;">Assistant</span>
      </a>
    </div>
    ...
    <div class="card">
      ...
      <!-- Hero illustration -->
      <div class="hero">
        <svg width="100%" viewBox="0 0 320 180" fill="none" xmlns="http://www.w3.org/2000/svg" style="max-width:320px;margin:0 auto;display:block;">
          ...
          <g transform="translate(28,30)">
            ...
            <rect x="10" y="12" width="20" height="20" rx="5" fill="#6c63ff" fill-opacity="0.2" stroke="#6c63ff" stroke-width="1"/>
          ...
          <g transform="translate(182,18)">
            <rect width="110" height="44" rx="10" fill="#1e1f2e" stroke="#2a2b3d" stroke-width="1"/>
            <rect x="10" y="12" width="20" height="20" rx="5" fill="#a78bfa" fill-opacity="0.15" stroke="#a78bfa" stroke-width="1"/>
          ...
          <g transform="translate(105,72)">
            <rect width="110" height="44" rx="10" fill="#1e1f2e" stroke="#6c63ff" stroke-width="1"/>
            <rect x="10" y="12" width="20" height="20" rx="5" fill="#60d9fa" fill-opacity="0.12" stroke="#60d9fa" stroke-width="1"/>
            <rect x="14" y="19" width="12" height="1.5" rx="1" fill="#60d9fa"/>
            <rect x="14" y="23" width="8" height="1.5" rx="1" fill="#60d9fa" fill-opacity="0.6"/>
            ...
            <circle cx="95" cy="10" r="7" fill="#6c63ff" fill-opacity="0.2"/>
          </g>

          <!-- Floating dots -->
          <circle cx="20" cy="140" r="3" fill="#6c63ff" fill-opacity="0.4"/>
          <circle cx="300" cy="50" r="2.5" fill="#a78bfa" fill-opacity="0.4"/>
          <circle cx="295" cy="145" r="2" fill="#60d9fa" fill-opacity="0.3"/>
          <circle cx="40" cy="170" r="1.5" fill="#a78bfa" fill-opacity="0.2"/>
      ...
      <div class="card-body">
        ...
        <!-- Warning note -->
        <div class="note">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" style="flex-shrink:0;margin-top:1px;">
            <path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" stroke="#ffba49" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            <line x1="12" y1="9" x2="12" y2="13" stroke="#ffba49" stroke-width="2" stroke-linecap="round"/>
            <line x1="12" y1="17" x2="12.01" y2="17" stroke="#ffba49" stroke-width="2" stroke-linecap="round"/>
          </svg>
          <p>
